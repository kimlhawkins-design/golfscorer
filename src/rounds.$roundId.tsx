    ...
    <div className="min-h-screen app-bg-green">
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 gap-3 mb-6 sm:grid-cols-2">
          <button
            type="button"
            onClick={() => openHole(selectedHole)}
            className="bg-green-500 hover:bg-green-400 text-white font-bold py-3 rounded-xl transition-colors shadow-lg shadow-green-950/20"
          >
            Enter scores for hole {selectedHole}
          </button>
          <button
            type="button"
            onClick={() => setGpsHole(selectedHole)}
            className="bg-white/10 hover:bg-white/20 border border-white/15 text-white font-bold py-3 rounded-xl transition-colors"
          >
            Use GPS on hole {selectedHole}
          </button>
        </div>
